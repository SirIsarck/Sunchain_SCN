...
SunChain is a Decentralized Physical Infrastructure Network (DePIN) connecting community solar hubs using Solana.
...
Rewards are calculated and distributed through smart contract logic that can be adapted to Solana Mainnet in future versions.

> Note: This demo illustrates how decentralized energy nodes can earn tokenized incentives for powering real-world infrastructure in the DePIN economy.



## MVP / Prototype Stage

The SunChain smart hub meter is currently at the prototype / MVP stage, designed to demonstrate the core concept:

Planned scope: 10 solar units across 3 pilot locations

Supporting 100+ users per hub

AI Agent + IoT integration ready for testing energy tracking, billing, and user management

Demonstrates the feasibility of the system, ready for deployment once funding and hardware expansion are secured


- Note: The system is planned for deployment, not yet live; all functionality is under prototype development and testing.
